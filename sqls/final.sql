...
CREATE SEQUENCE notification_id_seq START WITH 100 INCREMENT BY 1;
...
CREATE SEQUENCE query_id_seq START WITH 100 INCREMENT BY 1;
DROP SEQUENCE wishlist_id_seq;
CREATE SEQUENCE wishlist_id_seq START WITH 100 INCREMENT BY 1;
DROP SEQUENCE cart_id_seq;
CREATE SEQUENCE cart_id_seq START WITH 100 INCREMENT BY 1;
DROP SEQUENCE product_cart_id_seq;
CREATE SEQUENCE product_cart_id_seq START WITH 100 INCREMENT BY 1;
DROP SEQUENCE collection_slot_id_seq;
CREATE SEQUENCE collection_slot_id_seq START WITH 100 INCREMENT BY 1;
DROP SEQUENCE voucher_id_seq;
CREATE SEQUENCE voucher_id_seq START WITH 1 INCREMENT BY 1;
DROP SEQUENCE payment_id_seq;
CREATE SEQUENCE payment_id_seq START WITH 100 INCREMENT BY 1;
DROP SEQUENCE order_id_seq;
CREATE SEQUENCE order_id_seq START WITH 100 INCREMENT BY 1;
DROP SEQUENCE order_product_id_seq;
CREATE SEQUENCE order_product_id_seq START WITH 100 INCREMENT BY 1;
