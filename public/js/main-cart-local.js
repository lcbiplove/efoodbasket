...
window.addEventListener("load", function () {
    ...
    var allCheckboxes, allQuantities, allTotals, allSubtractBtns, allAddBtns, allDeleteBtns;
        ...
        allAddBtns.forEach(function (item, index) {
            item.onclick = function (e) {
                ...
                if(getCartItemsCount() < 20) {
                    ...
                    updateElems();
                    (document.querySelectorAll('.each-quantity')[index]).innerHTML = cartLS.get(product_id).quantity;
                } else {
