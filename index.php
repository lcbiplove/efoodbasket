...
$router->add("ajax/products/{product_id:\d+}/add-review/", ['controller' => 'Review', 'action' => 'add']);
$router->add("ajax/products/{product_id:\d+}/delete-review/", ['controller' => 'Review', 'action' => 'delete']);
